...
<body>
    ...
    <!-- Activity -->
    <form action="edit-my-club-validation.php" method="post" enctype="multipart/form-data">
        <div class="liner">
            ...
            <input type="submit" class="btn btn-primary" value="Submit" style="width: 97.5%; margin-left: 20px;  ; text-align: center;" >
    </form>
